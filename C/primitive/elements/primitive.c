...
static int32_t decodePrimitive(jetName* result, bitstream* stream) {
  ...
  if (!bit) {
    ...
    if (!bit) {
      ...
      switch (code) {
        case 0x0: return either(result, ADD32, SUBTRACT32, stream);
        case 0x1: *result = MULTIPLY32; return 0;
        case 0x2: return either(result, FULL_ADD32, FULL_SUBTRACT32, stream);
        case 0x3: *result = FULL_MULTIPLY32; return 0;
      }

      assert(false);
      UNREACHABLE;
    } else {
      return either(result, SHA256_HASHBLOCK, BIP0340_VERIFY, stream);
    }
  }
}
...
#define MK_JET(name, h0, h1, h2, h3, h4, h5, h6, h7) \
  do { \
    ...
    MK_JET(ADD32,            0xe40466a7u, 0xecf71ce8u, 0x62fb3c15u, 0x4c1e8f84u, 0x5d7e5707u, 0x463a8945u, 0x37a32fc7u, 0x214900adu);
    MK_JET(FULL_ADD32,       0x4727361eu, 0xa003c1a4u, 0x83e57505u, 0xcf5b405au, 0x8227da1au, 0xddc47e2bu, 0x016c2d09u, 0xbe047fe8u);
    MK_JET(SUBTRACT32,       0xf76ecad1u, 0xfda50f13u, 0x5bdfe3e5u, 0x33a15009u, 0x8f406261u, 0xc76f6dbfu, 0x6725f1e3u, 0x883c2ae2u);
    MK_JET(FULL_SUBTRACT32,  0x6d96f68au, 0x945c22e7u, 0x62115c09u, 0x4297b194u, 0xbedc0ce5u, 0xa0c92db6u, 0x4b830a18u, 0xb44df0d0u);
    MK_JET(MULTIPLY32,       0x161fd03au, 0x92c621b3u, 0x289849ffu, 0x29ad8134u, 0x99d63ed9u, 0x73db0e97u, 0x51785421u, 0xf568d18fu);
    MK_JET(FULL_MULTIPLY32,  0xaac25361u, 0xe598e354u, 0x38b918b5u, 0x8fd2cef4u, 0xdb3c5d8cu, 0x5e63aa4fu, 0x25e9cec0u, 0xcfd9dfb1u);
    MK_JET(SHA256_HASHBLOCK, 0xdfc927d3u, 0x9bf7147au, 0x8b0a7f43u, 0x79466870u, 0x824db102u, 0x090a0036u, 0x2923a377u, 0xa91af681u);
    MK_JET(BIP0340_VERIFY,   0x81e6f5dfu, 0xbabbb004u, 0xf191839fu, 0x3920bf08u, 0x0b9add24u, 0x6a047b7eu, 0xe73c9e16u, 0x1d2f1e1fu);
#undef MK_JET

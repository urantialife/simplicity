...
static int secp256k1_schnorrsig_verify(const secp256k1_ecmult_context* ecmult_ctx, const unsigned char *sig64, const unsigned char *msg32, const secp256k1_xonly_pubkey *pubkey) {
    secp256k1_scalar s;
    secp256k1_scalar e;
    secp256k1_gej rj;
    secp256k1_ge pk;
    ...
    secp256k1_ecmult(ecmult_ctx, &rj, &pkj, &e, &s);
